    ...
    <>
      <section className="pt-0">
        ...
        <div className="container">
          <SecTitle title="terms of us" subTitle="These Terms of Use you should know" />
          <ul className="text-gray-500 space-y-6">
            <li className="ltr:pl-10 rtl:pr-10  relative before:absolute rtl:before:-right-0 ltr:before:-left-0 before:top-1/2 before:-translate-y-1/2 before:bg-accent before:rounded-full before:w-[30px] before:h-[30px]">
